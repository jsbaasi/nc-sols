'''
do tweet ids come in non-decreasing, so we can use them as a timestamp?
thus we could just order by the tweet ids, but i think that would be too easy
because you could just sort the ids in this question and they would say
